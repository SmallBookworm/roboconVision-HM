...
public:
    ...
    const static int SD = 690;
    const static int SLEFTD = 689;
    const static int SRIGHTD = 690;
    const static int SPIX_LIGHT_HEIGHT = 163;
    const static int SPIX_LEFT_HEIGHT = 164;
    const static int SPIX_RIGHT_HEIGHT = 163;
    ...
    constexpr static float SINIT_ANGLE = -1.2;
    constexpr static float SLEFTTOCENTER = -113;//$$$$$$$$$$$$$$$$$$
    constexpr static float SRIGHTTOCENTER = 106.6;//$$$$$$$$$$$$$$$$$$
